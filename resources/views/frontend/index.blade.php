      ...
      <div class="container d-flex justify-content-center align-items-center">
        <div class="row">
          ...
          <div class="col-12 mt-auto mb-5 text-center">
            ...
            <h1 class="text-white mb-5">Night Live @php echo date("Y") @endphp</h1>
          ...
          <div class="col-lg-12 col-12 mt-auto d-flex flex-column flex-lg-row text-center">
            <div class="date-wrap">
              <h5 class="text-white">
                ...
                10 - 12<sup>th</sup>, Dec @php echo date("Y") @endphp
              </h5>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-12">
            <div class="pricing-thumb">
              ...
              <a class="link-fx-1 color-contrast-higher mt-4" href="{{ route('ticket') }}">
          ...
          <div class="col-lg-8 col-12 mx-auto">
            ...
            <div class="tab-content shadow-lg mt-5" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-ContactForm" role="tabpanel"
                ...
                {{-- {{ $message }} --}}
                <form class="custom-form contact-form mb-5 mb-lg-0" action="{{ route('contactForm') }}" method="post"
                  role="form">
                  @csrf
                  <div class="contact-form-body">
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-12">
                        <input type="text" name="fullname" id="contact-name" class="form-control"
